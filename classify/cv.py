...
masterPath = BASE_DIR3 = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
...
def cv(datasetId=None, network=None, nGPU=None, batchSize=16, numEpochs=300, feature=36, subTorun=None,
       centerLossEnable=False, cllr=0.01, Lambda=0.001, dropoutP=0):
    ...
    config['modelTrainArguments'] = {
        ...
        'bestVarToCheck': 'valInacc', 'continueAfterEarlystop': True, 'lr': 1e-3, 'feature': feature,
        'cllr': cllr, 'Lambda': Lambda}
...
if __name__ == '__main__':
    ...
    cv(datasetId=0, network='TSFCNet4a', nGPU='0', batchSize=32, numEpochs=300, feature=36, subTorun=None,
